...
export class TodoUI {
  ...
  static renderProjectTodos(project) {
    ...
    project.todos.forEach(todo => {
      ...
      const titleEl = DOM.createElement(
        "div",
      ...
      const dateEl = DOM.createElement(
        "div",
        ["due-date"],
  ...
  static createTodoExpandDialog(todo) {
    ...
    const descContent = DOM.createElement(
      "span",
      [],
      todo.desc ? todo.desc : "Not Set"
    );
    ...
    const dueTimeContent = DOM.createElement(
      "span",
      [],
      todo.dueTime ? todo.dueTime : "Not Set"
    );
    ...
    DOM.appendChildren(todoDetails, [
      titleExpand,
      descExpand,
      dueDateExpand,
      dueTimeExpand,
